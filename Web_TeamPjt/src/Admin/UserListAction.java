 ...
 * 
 * private String type = "id"; // �˻� ���� private String search = ""; // �˻���
 * private String order = "date"; // ���� ���� private int curPageNum = 1;
 * 
...
/*
 * 
 * // type �� ���� switch(type) { case "id": case "nickname": case "email":
 * break; default: type = "id"; }
 * 
 * // search �� ���� if (search.trim().equals("")) search = null;
 * 
 * // order �� ���� switch(order) { case "id": case "nickname": case "email":
 * case "date": break; default: order = "date"; }
 * 
 * // curPageNum �� ���� int pageCount = (userDAO.getDBCount(type, search) - 1)
 * / 10 + 1;
 * 
 ...
 *//***** request ������ *//*
							 ...
							 * 
							 * // �Է¹��� Parameter ��ȯ request.setAttribute("type", this.type);
