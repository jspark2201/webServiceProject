...
%>
	...
	<div class="container" style="background-color:#ffffff; border:1px solid #a6a6a6; margin-bottom:50px;">
		...
		<form action="<%=request.getContextPath()%>/board/boardModifyAction.jsp" method="post"  enctype="multipart/form-data">
				...
				<div class="col-sm-8">
					<textarea name="title" id="title" class="form-control" style="width:50%"><%=board.getTitle()%></textarea>
				</div>
			</div>
			<div class="row margin30">
				<div class="col-sm-4">
			...
			<div class="row margin15">
				...
				<div class="col-sm-8">
					<div class="form-group ">
				        ...
				        <input type = "checkbox" name = "platform" value = "web"><%=board.isWeb()%>web
			...
			<div class="row margin30">
				...
				<div class="col-sm-8">
					 <textarea class="a_400" name="requirements" id="requirements" placeholder="소개하시려는 아이디어 프로젝트를 쉽게 풀어서 작성하여 주십시오." maxlength="3000" rows="10" cols="40"><%=board.getRequirements()%></textarea>
	...
	<div class="message"></div>
		...
		<div style="text-align:center; margin-bottom:80px;">
			<button type="submit" class="btn btn-warning a_400">수정하기</button>
