...
<body>
   ...
   int totalRowCount = boardDao.selectFavoriteTotalBoardCount(interest1, interest2);
   int pagePerRow = 9;
   ...
   <div>
      ...
      <li class="page-item"><a class="page-link"
         href="<%=request.getContextPath()%>/board/boardInterestList.jsp?currentPage=<%=currentPage - 1%>">이전</a>
      </li>
      <%
         }
      ...
      %>
      <li class="page-item"><a class="page-link"
         href="<%=request.getContextPath()%>/board/boardInterestList.jsp?currentPage=<%=currentPage + 1%>">다음</a>
      </li>
