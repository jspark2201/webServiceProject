...
<body>
	...
	<%
		...
		int totalRowCount = boardDao.selectTotalSearchBoardCount(Search);
		int pagePerRow = 4;
	...
	<!-- 필터링 박스  -->
			...
			<label class="btn btn-warning"></label> <a
				href="/Web_TeamPjt/IdeaController?action=all" class="a_400"
				style="color: #333333;">전체 완료 아이디어 보기</a> <label
				class="btn btn-warning"></label> <a
				href="/Web_TeamPjt/IdeaController?action=recruit" class="a_400"
				style="color: #333333;">모집 중 아이디어 보기</a> <label
				class="btn btn-warning"></label> <a
				href="/Web_TeamPjt/IdeaController?action=complete" class="a_400"
				style="color: #333333;">모집 완료 아이디어 보기</a>
					</div>
            </div>
        </div>
	...
	<div>
		...
		<li class="page-item"><a class="page-link"
			href="<%=request.getContextPath()%>/board/boardSearchList.jsp?currentPage=<%=currentPage - 1%>">이전</a>
		</li>
		<%
			}
