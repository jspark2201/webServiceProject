...
<%
        if(currentPage>1) {
%>
            <a href="<%=request.getContextPath()%>/board/boardSearchList.jsp?currentPage=<%=currentPage-1%>">이전</a>
<%
        }
        if(currentPage < lastPage) {
%>
            <a href="<%=request.getContextPath()%>/board/boardSearchList.jsp?currentPage=<%=currentPage+1%>">다음</a>
<%
        }
