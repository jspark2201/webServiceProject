...
<body>
	...
	int totalRowCount = boardDao.selectTotalCompleteBoardCount();
	int pagePerRow = 4;
            ...
            <div class="col-md-12" style="margin-bottom:10px;">
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
						<label class="btn btn-warning">
							<input type="radio" name="jb-radio" id="jb-radio-1" checked><a href="<%=request.getContextPath()%>/board/boardList.jsp" class="a_400" style="color:#333333;">전체 아이디어 보기</a>
						</label>
						<label class="btn btn-warning">
							<input type="radio" name="jb-radio" id="jb-radio-2"><a href="<%=request.getContextPath()%>/board/boardRecruitList.jsp" class="a_400" style="color:#333333;">모집 중 아이디어 보기</a>
						</label>
						<label class="btn btn-warning">
							<input type="radio" name="jb-radio" id="jb-radio-3"><a href="<%=request.getContextPath()%>/board/boardCompleteList.jsp" class="a_400" style="color:#333333;">모집 완료 아이디어 보기</a>
						</label>
					</div>
            </div>
        </div>
	    ...
	    <div class="container">
	      <div class="row align-items-center">
	        <div class="col-lg-6 order-lg-2">
	          <div class="p-5">
	            <img style="height:400px;width:400px;" class="img-fluid rounded-circle" src="<%=b.getSrc()%>" alt="">
	          </div>
	        </div>
	...
	<div>
		...
		<a class="btn btn-outline-warning"
			href="<%=request.getContextPath()%>/board/boardCompleteList.jsp?currentPage=<%=currentPage - 1%>">이전</a>
		<%
			}
		if (currentPage < lastPage) {
		%>
		<a class="btn btn-outline-warning"
			href="<%=request.getContextPath()%>/board/boardCompleteList.jsp?currentPage=<%=currentPage + 1%>">다음</a>
