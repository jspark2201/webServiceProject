...
<%
        if(currentPage>1) {
%>
            <a href="<%=request.getContextPath()%>/board/boardCompleteList.jsp?currentPage=<%=currentPage-1%>">이전</a>
<%
        }
        if(currentPage < lastPage) {
%>
 
            <a href="<%=request.getContextPath()%>/board/boardCompleteList.jsp?currentPage=<%=currentPage+1%>">다음</a>
<%
        }
%>
    </div>
