...
<head>
<meta charset="UTF-8">
<title>idea modify action</title>
</head>
<body>
<%
if(request.getParameter("boardNo") == null) {
    ...
    System.out.println("수정action boardNo :"+Id);
	...
	System.out.println("수정"+Src);

	String Requirements = multi.getParameter("requirements");
	System.out.println("수정"+Requirements);
