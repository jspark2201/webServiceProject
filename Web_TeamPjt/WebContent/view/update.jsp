			...
			<div
				...
				<form role="form" method="post" action="/Web_TeamPjt/Login">
					<div class="row" style="margin-top: 30px; margin-bottom: 15px;">
						...
						<div class="col-sm-8">
							<input type="text" name="nickname"
								value="<jsp:getProperty name="event" property="nickname" /> "
					...
					<div class="row" style="margin-top: 30px; margin-bottom: 15px;">
						...
						<div class="col-sm-8">
							<input type="text" name="email"
								value="<jsp:getProperty name="event" property="email" /> "
								class="form-control input-lg" placeholder="Email" tabindex="6">
						</div>
					</div>
					<div class="row" style="margin-top: 30px; margin-bottom: 15px;">
						...
						<div class="col-sm-8">
							<input type="text" name="number"
								value="<jsp:getProperty name="event" property="number" /> "
								class="form-control input-lg" placeholder="Phone" tabindex="6">
						</div>
					</div>
					<div class="row" style="margin-top: 30px; margin-bottom: 15px;">
						<div class="col-sm-5 a_400" style="margin-top: 5px;">프로젝트
							플랫폼</div>
						<div class="col-sm-7">
							<div class="form-group ">
								<select id="test" name="interest" class="form-control a_400"
									style="width: 50%">
					...
					<div class="row" style="margin-top: 30px; margin-bottom: 15px;">
						...
						<div class="col-sm-7">
							<div class="form-group ">
								<select id="test1" name="interest1" class="form-control a_400"
									style="width: 50%">
					...
					<script>
						window.onload = function() {
							$("#test")
									.val(
											"<jsp:getProperty name="event" property="platform" />")
									.attr("selected", "selected");
							$("#test1")
									.val(
											"<jsp:getProperty name="event" property="genre" />")
									.attr("selected", "selected");
						}
					</script>
					...
					<div class="row">
						<div class="col-xs-8 col-sm-9 col-md-9">
							...
							you agree to the <a href="#" data-toggle="modal"
								data-target="#myModal"> Terms and Conditions</a> set out by this
