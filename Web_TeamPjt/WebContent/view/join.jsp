			...
			<div
				...
				<form role="form" method="post" action="../Login">
					...
					<div class="btn-group" style="margin-bottom: 20px;">
						<button type="button" class="btn btn-primary a_400">관심
							플랫폼</button>
						<button type="button"
						...
						<div class="dropdown-menu">
							<a class="dropdown-item" href="#">인공지능</a> <a
								class="dropdown-item" href="#">안드로이드</a> <a
								class="dropdown-item" href="#">IOS</a>
						</div>
