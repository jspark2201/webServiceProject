...
if (list.get(i).getState() == 1 && Ptype == 0) {
				...
				<div id="home" class="container tab-pane active">
					...
					<ul class="pagination justify-content-center">
						...
						<ul class="pagination justify-content-center">
							...
							%>
							<li class="page-item"><a class="page-link"
								href="/Web_TeamPjt/mypage/?pageNumber=<%=pageNumber%>"> <%=pageNumber%>
							</a></li>
							<%
				...
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary"
							...
							data-target="#response_mailModal">
							<a onclick="writeTitle()" class="a_400">답장하기</a>
						</button>
						<button type="button" class="btn btn-secondary"
							data-dismiss="modal">
							<a class="a_400">닫기</a>
	...
	<!-- 쪽지 작성 MODAL -->
	<form action="/Web_TeamPjt/SendNote?action=send" method="post">
		<div class="modal fade" id="response_mailModal">
			<div class="modal-dialog modal-xl">
				<div class="modal-content">
					...
					<div class="modal-body">
						<hr>
						<textarea name="sendContent" class="a_400" id="field"
							placeholder="보내실 내용을 입력하여 주세요.(200자)" maxlength="200" rows="10"
							cols="40"></textarea>
					</div>

					<!— Modal footer —>
					<div class="modal-footer">
						<input id="receiveID" name="noteRecevieID" type="hidden"
							value="aaa"></input> <input id="reSendTitle" name="sendTitle"
							type="hidden" value="abc"></input>
